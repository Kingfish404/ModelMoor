    ...
    var body: some View {
        VStack(spacing: 0) {
            VStack(alignment: .leading, spacing: 18) {
                ...
                Form {
                    Section("Connection") {
                        TextField("Name", text: $name, prompt: Text(verbatim: "DGX Spark"))
...
private struct PortForwardFields: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 5) {
                ...
                Text(verbatim: "ssh \(mapping.direction.sshFlag) \(mapping.forwardingSpecification) \(sshHost.isEmpty ? "<ssh-alias>" : sshHost)")
    ...
    private var listenerFields: some View {
        Picker("Address", selection: $mapping.listenHost) {
            Text(verbatim: "127.0.0.1").tag("127.0.0.1")
            Text(verbatim: "localhost").tag("localhost")
        }
