...
/// Management API surface consumed by ModelMoorSession. Implementations are
/// values because URLSession already provides request concurrency and
/// cancellation; tests may inject an actor-backed recorder.
public protocol CLIProxyManaging: Sendable {
...
extension CLIProxyManagementClient: CLIProxyManaging {}
